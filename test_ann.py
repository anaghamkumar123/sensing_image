...
with open('ann_feature.pkl','rb') as f:
    ann_feature=pickle.load(f)
prediction=ann_model.predict(feature)
prediction=numpy.argmax(prediction,axis=1)
d={0:'airport',1:'bareland',2:'playground',3:'railwaystation'}
print(d[prediction[0]])
test_feature=ann_model.predict(feature)
s=ann_feature.shape
